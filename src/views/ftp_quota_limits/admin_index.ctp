<div class="ftpQuotaLimits index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ftp_user_id');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $ftpQuotaLimit['FtpQuotaLimit']['id']; ?>&nbsp;</td>
		<td><?php echo $ftpQuotaLimit['FtpQuotaLimit']['ftp_user_id']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($ftpQuotaLimit['FtpUser']['name'], array('controller' => 'ftp_users', 'action' => 'view', $ftpQuotaLimit['FtpUser']['id'])); ?>
		</td>
		...
		<td><?php echo $ftpQuotaLimit['FtpQuotaLimit']['bytes_in_avail']; ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $ftpQuotaLimit['FtpQuotaLimit']['name'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $ftpQuotaLimit['FtpQuotaLimit']['name'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $ftpQuotaLimit['FtpQuotaLimit']['name']), null, sprintf(__('Are you sure you want to delete # %s?', true), $ftpQuotaLimit['FtpQuotaLimit']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
