...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Ftp Quota Limit', true), array('action' => 'edit', $ftpQuotaLimit['FtpQuotaLimit']['name'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Ftp Quota Limit', true), array('action' => 'delete', $ftpQuotaLimit['FtpQuotaLimit']['name']), null, sprintf(__('Are you sure you want to delete # %s?', true), $ftpQuotaLimit['FtpQuotaLimit']['name'])); ?> </li>
