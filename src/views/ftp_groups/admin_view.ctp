...
<div class="related">
	...
	<?php
		...
		?>
		<tr<?php echo $class;?>>
			<td><?php echo $ftpUser['id'];?></td>
			<td><?php echo $ftpUser['ftp_group_id'];?></td>
			<td><?php echo $ftpUser['name'];?></td>
			<td><?php echo $ftpUser['email'];?></td>
			<td><?php echo $ftpUser['userid'];?></td>
			<td><?php echo $ftpUser['uid'];?></td>
			<td><?php echo $ftpUser['gid'];?></td>
			<td><?php echo $ftpUser['passwd'];?></td>
			<td><?php echo $ftpUser['status'];?></td>
			<td><?php echo $ftpUser['expired'];?></td>
			<td><?php echo $ftpUser['homedir'];?></td>
			<td><?php echo $ftpUser['shell'];?></td>
			<td><?php echo $ftpUser['count'];?></td>
			<td><?php echo $ftpUser['accessed'];?></td>
			<td><?php echo $ftpUser['modified'];?></td>
			<td class="actions">
